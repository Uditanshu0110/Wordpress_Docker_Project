    ...
    public function add_tabs() {
        ...
        $screen->add_help_tab( array(
            ...
            'content' =>
                ...
                '<p><a href="' . esc_url( admin_url( 'admin.php?page=pixelgrade_assistant-setup-wizard' ) ) . '" class="button button-primary">' . esc_html__( 'Setup Pixelgrade Assistant', 'pixelgrade-assistant' ) . '</a></p>',
        ) );
    }
